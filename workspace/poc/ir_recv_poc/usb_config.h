#ifndef UIAP_IR_RECV_USB_CONFIG_H
#define UIAP_IR_RECV_USB_CONFIG_H
...
#define IR_REPORT_SIZE 8u

#ifndef __ASSEMBLER__
#include <stdint.h>
#ifdef INSTANCE_DESCRIPTORS

/* Temporary PoC VID/PID. These are not product assignments. */
...
/* Vendor-defined interrupt-IN report, exactly 8 bytes. */
static const uint8_t ir_hid_desc[] = {
    0x06, 0x00, 0xFF,
    0x09, 0x09,
    0xA1, 0x01,
    0x15, 0x00,
...
static const uint8_t config_descriptor[] = {
    ...
    9, 0x21, 0x11, 0x01, 0, 1, 0x22, sizeof(ir_hid_desc), 0,
    7, 0x05, 0x81, 0x03, IR_REPORT_SIZE, 0x00, 10
};

#define STR_MANUFACTURER u"UIAP Workshop"
#define STR_PRODUCT u"UIAP IR Receiver PoC"
#define STR_SERIAL u"IR-POC-001"
...
static const struct descriptor_list_struct {
    ...
    {0x00002200, ir_hid_desc, sizeof(ir_hid_desc)},
