#ifndef UIAP_IR_SEND_USB_CONFIG_H
#define UIAP_IR_SEND_USB_CONFIG_H
...
#define IR_SEND_REPORT_ID 0x01
#define IR_SEND_DATA_SIZE 10
#define IR_SEND_REPORT_PAYLOAD_SIZE 13
#define IR_SEND_REPORT_TOTAL_SIZE 14
...
/* 主催者PoC用の暫定識別子。正式な製品識別子として使用しない。 */
#define UIAP_USB_VID 0x1209
#define UIAP_USB_PID 0xD00A
...
/* Report ID 1, payload=[command, length, count, data(10), status on GET]. */
static const uint8_t ir_send_hid_desc[] = {
    0x06, 0x00, 0xff,
    0x09, 0x0a,
    0xa1, 0x01,
    0x85, IR_SEND_REPORT_ID,
    0x09, 0x0a,
    0x15, 0x00,
    0x26, 0xff, 0x00,
    0x75, 0x08,
    0x95, IR_SEND_REPORT_PAYLOAD_SIZE,
    0xb1, 0x02,
    0xc0
};
...
static const uint8_t config_descriptor[] = {
    ...
    sizeof(ir_send_hid_desc), 0x00,
    7, 5, 0x81, 0x03, 0x01, 0x00, 100
};

#define STR_MANUFACTURER u"UIAP Workshop"
#define STR_PRODUCT      u"UIAP IR Sender PoC"
#define STR_SERIAL       u"IR-SEND-001"
...
static const struct descriptor_list_struct {
    ...
    {0x00002200, ir_send_hid_desc, sizeof(ir_send_hid_desc)},
