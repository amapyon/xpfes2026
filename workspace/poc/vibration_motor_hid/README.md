...
2026-08-01に、構成変更後のファームウェアについてWindows 11 x64でビルド、書き込み、USB HID制御、振動モーター動作を再確認しました。macOS Apple Siliconでは未検証です。
...
USBはLow-SpeedのVendor-defined HIDです。アプリケーションの暫定VID:PIDは`1209:D003`、ブートローダーは`1209:B803`です。
