#ifndef UIAP_JOYSTICK_MOUSE_USB_CONFIG_H
#define UIAP_JOYSTICK_MOUSE_USB_CONFIG_H
...
/* Vendor HID input: signed X level, signed Y level, pressed flag, sequence. */
static const uint8_t joystick_hid_desc[] = {
    0x06, 0x00, 0xFF,
    0x09, 0x01,
    0xA1, 0x01,
    0x15, 0x00,
...
static const uint8_t config_descriptor[] = {
    ...
    9, 0x21, 0x11, 0x01, 0, 1, 0x22, sizeof(joystick_hid_desc), 0,
    7, 0x05, 0x81, 0x03, 0x04, 0x00, 10
};

#define STR_MANUFACTURER u"UIAP Workshop"
#define STR_PRODUCT u"UIAP Joystick Mouse"
#define STR_SERIAL u"POC-JOY-001"
...
static const struct descriptor_list_struct {
    ...
    {0x00002200, joystick_hid_desc, sizeof(joystick_hid_desc)},
