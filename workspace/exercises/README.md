...
4つの正式演習を配置します。すべてのファームウェアとビルド設定はWindows/macOS共通です。`02_rotary_cursor_size`と`03_rotary_cursor_haptic`は、それぞれ単一ホストが実行時にOSバックエンドを選択します。
...
- `03_rotary_cursor_haptic`: `02`の回路と処理へ振動モジュールを追加し、サイズ変更時に触覚フィードバックを返す演習
